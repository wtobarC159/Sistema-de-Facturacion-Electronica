...
{
    /// <inheritdoc />
    public partial class VA1 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UsuarioApp = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FechaAutorizacion = table.Column<DateTime>(type: "Date", nullable: false),
                    NumeroAutorizacion = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    NombreCliente = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Subtotal = table.Column<double>(type: "float", nullable: false),
                    TotalIPT = table.Column<double>(type: "float", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ImpAplicablesId = table.Column<int>(type: "int", nullable: false),
                    ProductosId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ImpuestoProducto", x => new { x.ImpAplicablesId, x.ProductosId });
                    table.ForeignKey(
                        name: "FK_ImpuestoProducto_Impuestos_ImpAplicablesId",
                        column: x => x.ImpAplicablesId,
                        principalTable: "Impuestos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ImpuestoProducto_Productos_ProductosId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Subtotal = table.Column<double>(type: "float", nullable: false),
                    TotalImpuesto = table.Column<double>(type: "float", nullable: false),
